...
export interface AiConversationState {
  state: 'START' | 'MENU' | 'COLLECTING_DETAILS' | 'COLLECTING_SYMPTOMS' | 'AWAITING_CONFIRMATION' | 'COLLECTING_APPOINTMENT_DATE' | 'COLLECTING_APPOINTMENT_TIME' | 'COMPLETE' | 'IDLE' | 'ANSWERING_ENQUIRIES' | 'ENQUIRY_CTA';
  data: Partial<{
